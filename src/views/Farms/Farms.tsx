...
import { useFarms, usePriceBnbBusd, usePriceCakeBusd, usePriceSdrBUSD } from 'state/hooks'
...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const farmsList = useCallback(
    ...
    [bnbPrice, account, cakePrice, sdrPrice, ethereum],
  )
  ...
  return (
    <Page>
      ...
      {/* <Heading as="h1" size="lg" color="primary" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            TranslateString(10002, 'Stake tokens to earn Yumcha')
            :
          TranslateString(320, 'Stake LP tokens to earn Yumcha')
        }
      </Heading>
      <Heading as="h2" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
        {TranslateString(10000, 'Deposit Fee will be used to buyback Yumcha')}
      </Heading> */}
